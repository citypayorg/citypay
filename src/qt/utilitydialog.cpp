    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  ctp-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Ctp in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
For more information, see the <a href=\"https://docs.citypay.org/en/latest/wallets/ctpcore/privatesend-instantsend.html\">PrivateSend documentation</a>. \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
