    ...
    mapper(0)
{
    ...
    ui->theme->addItem(QString("CTP-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("CTP-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("CTP-light-hires-retro"), QVariant("light-hires-retro"));
