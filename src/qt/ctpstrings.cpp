...
#define UNUSED
#endif
static const char UNUSED *ctp_strings[] = {
QT_TRANSLATE_NOOP("ctp-core", "Ctp Core"),
QT_TRANSLATE_NOOP("ctp-core", "The %s developers"),
...
QT_TRANSLATE_NOOP("ctp-core", ""
"Disable all Ctp specific functionality (Masternodes, PrivateSend, "
...
QT_TRANSLATE_NOOP("ctp-core", "Add a node to connect to and attempt to keep the connection open"),
QT_TRANSLATE_NOOP("ctp-core", "Allow DNS lookups for -addnode, -seednode and -connect"),
QT_TRANSLATE_NOOP("ctp-core", "Allow RFC1918 addresses to be relayed and connected to (default: %u)"),
QT_TRANSLATE_NOOP("ctp-core", "Already have that input."),
QT_TRANSLATE_NOOP("ctp-core", "Always query for peer addresses via DNS lookup (default: %u)"),
QT_TRANSLATE_NOOP("ctp-core", "Append comment to the user agent string"),
QT_TRANSLATE_NOOP("ctp-core", "Attempt to recover private keys from a corrupt wallet on startup"),
QT_TRANSLATE_NOOP("ctp-core", "Automatic backups disabled"),
QT_TRANSLATE_NOOP("ctp-core", "Automatically create Tor hidden service (default: %d)"),
QT_TRANSLATE_NOOP("ctp-core", "Block creation options:"),
QT_TRANSLATE_NOOP("ctp-core", "Can't find random Masternode."),
QT_TRANSLATE_NOOP("ctp-core", "Can't mix while sync in progress."),
QT_TRANSLATE_NOOP("ctp-core", "Can't mix: no compatible inputs found!"),
QT_TRANSLATE_NOOP("ctp-core", "Cannot downgrade wallet"),
QT_TRANSLATE_NOOP("ctp-core", "Cannot resolve -%s address: '%s'"),
QT_TRANSLATE_NOOP("ctp-core", "Cannot write default address"),
QT_TRANSLATE_NOOP("ctp-core", "Chain selection options:"),
QT_TRANSLATE_NOOP("ctp-core", "Change index out of range"),
QT_TRANSLATE_NOOP("ctp-core", "Collateral not valid."),
QT_TRANSLATE_NOOP("ctp-core", "Connect through SOCKS5 proxy"),
QT_TRANSLATE_NOOP("ctp-core", "Connect to KeePassHttp on port <port> (default: %u)"),
QT_TRANSLATE_NOOP("ctp-core", "Connect to a node to retrieve peer addresses, and disconnect"),
...
QT_TRANSLATE_NOOP("ctp-core", "Done loading"),
QT_TRANSLATE_NOOP("ctp-core", "ERROR! Failed to create automatic backup"),
QT_TRANSLATE_NOOP("ctp-core", "Enable publish hash block in <address>"),
QT_TRANSLATE_NOOP("ctp-core", "Enable publish hash of governance objects (like proposals) in <address>"),
QT_TRANSLATE_NOOP("ctp-core", "Enable publish hash of governance votes in <address>"),
QT_TRANSLATE_NOOP("ctp-core", "Enable publish hash transaction (locked via InstantSend) in <address>"),
QT_TRANSLATE_NOOP("ctp-core", "Enable publish hash transaction in <address>"),
QT_TRANSLATE_NOOP("ctp-core", "Enable publish raw block in <address>"),
...
QT_TRANSLATE_NOOP("ctp-core", "Error initializing wallet database environment %s!"),
QT_TRANSLATE_NOOP("ctp-core", "Error loading %s"),
QT_TRANSLATE_NOOP("ctp-core", "Error loading %s: Wallet corrupted"),
QT_TRANSLATE_NOOP("ctp-core", "Error loading %s: Wallet requires newer version of %s"),
QT_TRANSLATE_NOOP("ctp-core", "Error loading %s: You can't disable HD on a already existing HD wallet"),
QT_TRANSLATE_NOOP("ctp-core", "Error loading block database"),
QT_TRANSLATE_NOOP("ctp-core", "Error opening block database"),
QT_TRANSLATE_NOOP("ctp-core", "Error reading from database, shutting down."),
QT_TRANSLATE_NOOP("ctp-core", "Error upgrading chainstate database"),
QT_TRANSLATE_NOOP("ctp-core", "Error"),
QT_TRANSLATE_NOOP("ctp-core", "Error: A fatal internal error occurred, see debug.log for details"),
QT_TRANSLATE_NOOP("ctp-core", "Error: Disk space is low!"),
QT_TRANSLATE_NOOP("ctp-core", "Failed to create backup %s!"),
QT_TRANSLATE_NOOP("ctp-core", "Failed to create backup, error: %s"),
QT_TRANSLATE_NOOP("ctp-core", "Failed to delete backup, error: %s"),
QT_TRANSLATE_NOOP("ctp-core", "Failed to find mixing queue to join"),
QT_TRANSLATE_NOOP("ctp-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("ctp-core", "Failed to load InstantSend data cache from"),
...
QT_TRANSLATE_NOOP("ctp-core", "Found enough users, signing ..."),
QT_TRANSLATE_NOOP("ctp-core", "How many blocks to check at startup (default: %u, 0 = all)"),
QT_TRANSLATE_NOOP("ctp-core", "Importing..."),
QT_TRANSLATE_NOOP("ctp-core", "Imports blocks from external blk000??.dat file on startup"),
QT_TRANSLATE_NOOP("ctp-core", "Include IP addresses in debug output (default: %u)"),
QT_TRANSLATE_NOOP("ctp-core", "Incompatible mode."),
QT_TRANSLATE_NOOP("ctp-core", "Incompatible version."),
QT_TRANSLATE_NOOP("ctp-core", "Incorrect or no genesis block found. Wrong datadir for network?"),
QT_TRANSLATE_NOOP("ctp-core", "Information"),
QT_TRANSLATE_NOOP("ctp-core", "Initialization sanity check failed. %s is shutting down."),
...
QT_TRANSLATE_NOOP("ctp-core", "KeePassHttp key for AES encrypted communication with KeePass"),
QT_TRANSLATE_NOOP("ctp-core", "Keep N CTP anonymized (%u-%u, default: %u)"),
QT_TRANSLATE_NOOP("ctp-core", "Keep at most <n> unconnectable transactions in memory (default: %u)"),
QT_TRANSLATE_NOOP("ctp-core", "Keep the transaction memory pool below <n> megabytes (default: %u)"),
...
QT_TRANSLATE_NOOP("ctp-core", "Maximum per-connection receive buffer, <n>*1000 bytes (default: %u)"),
QT_TRANSLATE_NOOP("ctp-core", "Maximum per-connection send buffer, <n>*1000 bytes (default: %u)"),
QT_TRANSLATE_NOOP("ctp-core", "Minimum bytes per sigop in transactions we relay and mine (default: %u)"),
QT_TRANSLATE_NOOP("ctp-core", "Missing input transaction information."),
QT_TRANSLATE_NOOP("ctp-core", "Mixing in progress..."),
QT_TRANSLATE_NOOP("ctp-core", "Mnemonic passphrase is too long, must be at most 256 characters"),
QT_TRANSLATE_NOOP("ctp-core", "Need to specify a port with -whitebind: '%s'"),
QT_TRANSLATE_NOOP("ctp-core", "No Masternodes detected."),
QT_TRANSLATE_NOOP("ctp-core", "No compatible Masternode found."),
QT_TRANSLATE_NOOP("ctp-core", "No errors detected."),
QT_TRANSLATE_NOOP("ctp-core", "No matching denominations found for mixing."),
QT_TRANSLATE_NOOP("ctp-core", "Node relay options:"),
QT_TRANSLATE_NOOP("ctp-core", "Non-standard public key detected."),
QT_TRANSLATE_NOOP("ctp-core", "Not compatible with existing transactions."),
QT_TRANSLATE_NOOP("ctp-core", "Not enough file descriptors available."),
QT_TRANSLATE_NOOP("ctp-core", "Not enough funds to anonymize."),
QT_TRANSLATE_NOOP("ctp-core", "Not in the Masternode list."),
QT_TRANSLATE_NOOP("ctp-core", "Number of automatic wallet backups (default: %u)"),
...
QT_TRANSLATE_NOOP("ctp-core", "PrivateSend is idle."),
QT_TRANSLATE_NOOP("ctp-core", "PrivateSend options:"),
QT_TRANSLATE_NOOP("ctp-core", "PrivateSend request complete:"),
QT_TRANSLATE_NOOP("ctp-core", "PrivateSend request incomplete:"),
QT_TRANSLATE_NOOP("ctp-core", "Prune cannot be configured with a negative value."),
QT_TRANSLATE_NOOP("ctp-core", "Prune mode is incompatible with -txindex."),
QT_TRANSLATE_NOOP("ctp-core", "Pruning blockstore..."),
QT_TRANSLATE_NOOP("ctp-core", "RPC server options:"),
QT_TRANSLATE_NOOP("ctp-core", "Rebuild chain state and block index from the blk*.dat files on disk"),
QT_TRANSLATE_NOOP("ctp-core", "Rebuild chain state from the currently indexed blocks"),
QT_TRANSLATE_NOOP("ctp-core", "Receive and display P2P network alerts (default: %u)"),
QT_TRANSLATE_NOOP("ctp-core", "Reducing -maxconnections from %d to %d, because of system limitations."),
QT_TRANSLATE_NOOP("ctp-core", "Relay and mine data carrier transactions (default: %u)"),
QT_TRANSLATE_NOOP("ctp-core", "Relay non-P2SH multisig (default: %u)"),
QT_TRANSLATE_NOOP("ctp-core", "Rescan the block chain for missing wallet transactions on startup"),
QT_TRANSLATE_NOOP("ctp-core", "Rescanning..."),
QT_TRANSLATE_NOOP("ctp-core", "Run in the background as a daemon and accept commands"),
QT_TRANSLATE_NOOP("ctp-core", "Send trace/debug info to console instead of debug.log file"),
QT_TRANSLATE_NOOP("ctp-core", "Send trace/debug info to debug.log file (default: %u)"),
QT_TRANSLATE_NOOP("ctp-core", "Send transactions as zero-fee transactions if possible (default: %u)"),
QT_TRANSLATE_NOOP("ctp-core", "Session not complete!"),
QT_TRANSLATE_NOOP("ctp-core", "Session timed out."),
...
QT_TRANSLATE_NOOP("ctp-core", "Signing transaction failed"),
...
QT_TRANSLATE_NOOP("ctp-core", "This is experimental software."),
QT_TRANSLATE_NOOP("ctp-core", "This is not a Masternode."),
QT_TRANSLATE_NOOP("ctp-core", "This is the minimum transaction fee you pay on every transaction."),
...
QT_TRANSLATE_NOOP("ctp-core", "Transaction amounts must not be negative"),
QT_TRANSLATE_NOOP("ctp-core", "Transaction created successfully."),
QT_TRANSLATE_NOOP("ctp-core", "Transaction fees are too high."),
QT_TRANSLATE_NOOP("ctp-core", "Transaction has too long of a mempool chain"),
QT_TRANSLATE_NOOP("ctp-core", "Transaction must have at least one recipient"),
QT_TRANSLATE_NOOP("ctp-core", "Transaction not valid."),
QT_TRANSLATE_NOOP("ctp-core", "Transaction too large for fee policy"),
QT_TRANSLATE_NOOP("ctp-core", "Transaction too large"),
QT_TRANSLATE_NOOP("ctp-core", "Trying to connect..."),
QT_TRANSLATE_NOOP("ctp-core", "Unable to bind to %s on this computer (bind returned error %s)"),
QT_TRANSLATE_NOOP("ctp-core", "Unable to bind to %s on this computer. %s is probably already running."),
QT_TRANSLATE_NOOP("ctp-core", "Unable to sign spork message, wrong key?"),
QT_TRANSLATE_NOOP("ctp-core", "Unable to start HTTP server. See debug log for details."),
QT_TRANSLATE_NOOP("ctp-core", "Unknown network specified in -onlynet: '%s'"),
QT_TRANSLATE_NOOP("ctp-core", "Unknown response."),
QT_TRANSLATE_NOOP("ctp-core", "Unknown state: id = %u"),
QT_TRANSLATE_NOOP("ctp-core", "Unsupported argument -benchmark ignored, use -debug=bench."),
QT_TRANSLATE_NOOP("ctp-core", "Unsupported argument -debugnet ignored, use -debug=net."),
QT_TRANSLATE_NOOP("ctp-core", "Unsupported argument -tor found, use -onion."),
QT_TRANSLATE_NOOP("ctp-core", "Upgrade wallet to latest format on startup"),
QT_TRANSLATE_NOOP("ctp-core", "Upgrading UTXO database"),
QT_TRANSLATE_NOOP("ctp-core", "Use KeePass 2 integration using KeePassHttp plugin (default: %u)"),
QT_TRANSLATE_NOOP("ctp-core", "Use UPnP to map the listening port (default: %u)"),
QT_TRANSLATE_NOOP("ctp-core", "Use devnet chain with provided name"),
QT_TRANSLATE_NOOP("ctp-core", "Use the test chain"),
QT_TRANSLATE_NOOP("ctp-core", "User Agent comment (%s) contains unsafe characters."),
QT_TRANSLATE_NOOP("ctp-core", "Username for JSON-RPC connections"),
QT_TRANSLATE_NOOP("ctp-core", "Verifying blocks..."),
QT_TRANSLATE_NOOP("ctp-core", "Verifying wallet..."),
QT_TRANSLATE_NOOP("ctp-core", "Very low number of keys left: %d"),
QT_TRANSLATE_NOOP("ctp-core", "Wallet %s resides outside data directory %s"),
QT_TRANSLATE_NOOP("ctp-core", "Wallet debugging/testing options:"),
QT_TRANSLATE_NOOP("ctp-core", "Wallet is locked."),
QT_TRANSLATE_NOOP("ctp-core", "Wallet is not initialized"),
QT_TRANSLATE_NOOP("ctp-core", "Wallet needed to be rewritten: restart %s to complete"),
QT_TRANSLATE_NOOP("ctp-core", "Wallet options:"),
QT_TRANSLATE_NOOP("ctp-core", "Wallet window title"),
QT_TRANSLATE_NOOP("ctp-core", "Warning"),
QT_TRANSLATE_NOOP("ctp-core", "Warning: unknown new rules activated (versionbit %i)"),
QT_TRANSLATE_NOOP("ctp-core", "Wasn't able to create wallet backup folder %s!"),
QT_TRANSLATE_NOOP("ctp-core", "Whether to operate in a blocks only mode (default: %u)"),
QT_TRANSLATE_NOOP("ctp-core", "Will retry..."),
QT_TRANSLATE_NOOP("ctp-core", "You can not start a masternode in lite mode."),
QT_TRANSLATE_NOOP("ctp-core", "Your entries added successfully."),
QT_TRANSLATE_NOOP("ctp-core", "Your transaction was accepted into the pool!"),
QT_TRANSLATE_NOOP("ctp-core", "Zapping all transactions from wallet..."),
QT_TRANSLATE_NOOP("ctp-core", "ZeroMQ notification options:"),
QT_TRANSLATE_NOOP("ctp-core", "no mixing available."),
QT_TRANSLATE_NOOP("ctp-core", "see debug.log for details."),
};
