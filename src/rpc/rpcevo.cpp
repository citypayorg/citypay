...
// Allows to specify Ctp address or priv key. In case of Ctp address, the priv key is taken from the wallet
...
void protx_register_fund_help()
{
    throw std::runtime_error(
            ...
            "\nCreates, funds and sends a ProTx to the network. The resulting transaction will move 1000 Ctp\n"
            "to the address specified by collateralAddress and will then function as the collateral of your\n"
            "masternode.\n"
            "A few of the limitations you see in the arguments are temporary and might be lifted after DIP3\n"
            "is fully deployed.\n"
            "\nArguments:\n"
            "1. \"collateralAddress\"   (string, required) The ctp address to send the collateral to.\n"
            ...
            "7. \"payoutAddress\"       (string, required) The ctp address to use for masternode reward payments\n"
...
void protx_update_registrar_help()
{
    throw std::runtime_error(
            ...
            "4. \"payoutAddress\"       (string, required) The ctp address to use for masternode reward payments\n"
