...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  payee          - Print Ctp address associated with a masternode (can be additionally filtered,\n"
            "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    ...
    { "ctp",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "ctp",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "ctp",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
