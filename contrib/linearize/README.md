# Linearize
Construct a linear, no-fork, best version of the Ctp blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install ctp_hash

https://github.com/ctppay/ctp_hash
...
JSON-RPC server. Running `ctpd` or `ctp-qt -server` will be sufficient.
...
* `input`: ctpd blocks/ directory containing blkNNNNN.dat
